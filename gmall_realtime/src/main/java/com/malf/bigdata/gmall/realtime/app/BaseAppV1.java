...
public abstract class BaseAppV1 {
    public void envInit(int restPort,int parallelism,String ckAndGroupIdAndJobName,String topic){
        ...
        handleDataSteam(environment,dataStream);
    ...
    abstract protected void handleDataSteam(StreamExecutionEnvironment environment, DataStreamSource<String> dataStream);
